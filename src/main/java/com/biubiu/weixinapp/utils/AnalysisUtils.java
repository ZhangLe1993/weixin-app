package com.biubiu.weixinapp.utils;
...
public class AnalysisUtils {
    ...
    public static DouYinModel douYin(String text) {
        ...
        queryHeaders.set(HttpHeaders.USER_AGENT, "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1");
        ...
        return new DouYinModel(urlListArr.get(0).replace("playwm", "play"), coverUrlListArr.get(0));
